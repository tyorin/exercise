...
// module.exports = function (db, date, callback) {
//   // util.debug(util.inspect(db));
//   // util.debug(util.inspect(date));
//   // util.debug(util.inspect(callback));
//   // db.createReadStream({'start':date}).on('data', function (data) {util.debug(util.inspect(data))});
//   var count = 0;
